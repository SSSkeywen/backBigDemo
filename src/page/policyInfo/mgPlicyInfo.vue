  ...
  <div class="mg-box">
    ...
    <section class="mp-box-one">
      <div class="mp-min-title">
        ...
        <div @click="showMpList(0)" class="mp-min-right">
          <img
            class="ani-down"
            :class="isShowInformation?'add-ani-style':''"
            :src="imgSrcThree"
            alt
          >
        </div>
      ...
      <ul class="mp-list" v-if="isShowInformation">
        ...
        <li class="mp-list-li line-down" v-if="InformationMap.InformationMaplist">
          <p>电子发票信息</p>
          <p>
            <button class="see-btn">查看详情</button>
          </p>
        </li>
      </ul>
    </section>
    ...
    <section class="mp-box-one">
      <div class="mp-min-title">
        ...
        <div @click="showMpList(2)" class="mp-min-right">
          <img
            class="ani-down"
            :class="isShowInformationThree?'add-ani-style':''"
            :src="imgSrcThree"
            alt
          >
        </div>
    ...
    <section class="mp-box-one">
      <div class="mp-min-title">
        ...
        <div @click="showMpList(3)" class="mp-min-right">
          <img
            class="ani-down"
            :class="isShowInformationFour?'add-ani-style':''"
            :src="imgSrcThree"
            alt
          >
        </div>
    ...
    <section class="mp-box-one">
      <div class="mp-min-title">
        ...
        <div @click="showMpList(4)" class="mp-min-right">
          <img
            class="ani-down"
            :class="isShowInformationFive?'add-ani-style':''"
            :src="imgSrcThree"
            alt
          >
        </div>
    ...
    <section class="mp-box-one">
      <div class="mp-min-title">
        ...
        <div @click="showMpList(5)" class="mp-min-right">
          <img
            class="ani-down"
            :class="isShowInformationSix?'add-ani-style':''"
            :src="imgSrcThree"
            alt
          >
        </div>
...
export default {
  ...
  methods: {
    ...
    showMpListPolicyMessage(index) {
      this.ProductList[index].isShowInformation = !this.ProductList[index]
        .isShowInformation;
    },

    //信件发送方式的显示
    showSendEmilStyle(index) {
      this.ProductList[index].isShowSendEmilStyle = !this.ProductList[index]
        .isShowSendEmilStyle;
    }
  }
};

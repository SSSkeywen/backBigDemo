          ...
          <ul>
            ...
            <li>
              <div>
                ...
                <input type="hidden" name="noticeType" id="转账成功通知书">
              </div>
            </li>
            <li>
              <div>
            ...
            <li class="btns">
              <button @click="changSendStyleFn(1,contentData.policyCode,contentData.paperNotice)">短信告知</button>
              <button @click="changSendStyleFn(2,contentData.policyCode,contentData.paperNotice)">电子邮箱</button>
              <button @click="changSendStyleFn(3,contentData.policyCode,contentData.paperNotice)">自助查询</button>
            </li>
          </ul>
        </div>
      </div>
